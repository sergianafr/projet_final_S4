INSERT INTO garage_type_vehicule values (default, 'legere'), (default, '4*4'), (default, 'utilitaire');

INSERT INTO garage_client values (default, '6090TBB', 1), (default, '7890TAB', 1), (default, '6009TBA', 3);

INSERT INTO garage_slot values
(default, 'A'), (default, 'B'), (default, 'C');

INSERT INTO garage_date_reference VALUES
(default, '2024-01-01');

INSERT INTO garage_admin VALUES
(default, 'asta@gmail.com', 'atlasss');

INSERT INTO garage_heure_travail VALUES
(default, '08:00:00', '18:00:00');

INSERT INTO garage_type_service values 
...
INSERT INTO garage_rendez_vous VALUES
(default, 1, '2024-07-07 8:00:00', '2024-07-02', 2, 1,  150000, default);
INSERT INTO garage_details_rdv VALUES
